...
export const countryCode = async (req, res) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: "Failed to fetch country code",
    });
  }
};
...
export const updateStatus = async (req, res) => {
  try {
    ...
    logger.error("updateThemeStatus error:", error);
...
//     await logActivity({
//       created_by: req.admin.id,
//       action: `Themes status updated by Admin ${req.admin.name} (${req.admin.emp_id})`,
//       module: "theme",
//       details: {
//         id: theme.id,
//         name: theme.name,
...
export const deleteTheme = async (req, res) => {
  try {
    ...
    await logActivity({
      created_by: req.admin.id,
      action: `Themes deleted by Admin ${req.admin.name} (${req.admin.emp_id})`,
      module: "theme",
      details: {
        theme,
      },
